...
public class Transfer1Adapter extends BaseAdapter {

    Context context ;
    List<ModelString> list;

    public Transfer1Adapter(Context context, List<ModelString> list, Activity activity){
...
//        Mytimeline_Item_Timeline
        ...
        buttontrans.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, Transferdetail1Activity.class);
