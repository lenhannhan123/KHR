...
import fpt.aptech.khrmobile.AddScheduleTimelineDetailActivity;
...
public class WorkScheduleAdapter extends BaseAdapter {
    ...
    public WorkScheduleAdapter(Context context, List<ModelString> list, Activity activity){
...
//        Mytimeline_Item_Timeline
        ...
        Mytimeline_Item_Timeline.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, AddScheduleTimelineDetailActivity.class);
