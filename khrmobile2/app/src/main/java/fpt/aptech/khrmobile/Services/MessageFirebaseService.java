...
import fpt.aptech.khrmobile.MessageAccountActivity;
...
public class MessageFirebaseService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(@NonNull RemoteMessage message) {
        if (message.getNotification() != null) {
            ...
            if(title.equals("Thông báo tin nhắn mới !")){
                sendMessageItem(title, body);
            }else{
    ...
    private void sendMessageItem(String messageTitle, String messageBody) {
        Intent intent = new Intent(this, MessageAccountActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        PendingIntent pendingIntent = PendingIntent.getActivity(this, 0, /* Request code */intent, PendingIntent.FLAG_ONE_SHOT);
